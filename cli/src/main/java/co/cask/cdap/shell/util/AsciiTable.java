...
public class AsciiTable<T> {
  ...
  /**
   * Prints the ASCII table to the {@link java.io.PrintStream} output.
   *
   * @param output {@link java.io.PrintStream} to print to
   */
   ...
   * Prints a divider.
   *
   * @param output The {@link java.io.PrintStream} to output to
   ...
   * @param collection Collection for collecting the generated {@link co.cask.cdap.shell.util.AsciiTable.Row} object.
  ...
  private static final class Cell implements Iterable<String> {
     ...
     *
     * @param output The {@link java.io.PrintStream} to write to.
  ...
  private static final class Row implements Iterable<Cell> {
    ...
    /**
     * Returns the {@link co.cask.cdap.shell.util.AsciiTable.Cell} at the given column.
     */
    Cell get(int i) {
      return cells.get(i);
    }
